...
module.exports = {
    entry: [path.resolve(__dirname, "./../src/parcel-entry.js")],
    options: {
        outDir: "./public/", // The out directory to put the build files in, defaults to dist
        outFile: `${pkg.name}.js`, // The name of the outputFile
        publicUrl: "./", // The url to serve on, defaults to '/'
        watch: false, // Whether to watch the files and rebuild them on change, defaults to process.env.NODE_ENV !== 'production'
        cache: true, // Enabled or disables caching, defaults to true
        cacheDir: ".parcel_cache", // The directory cache gets put in, defaults to .cache
    ...
    transforms: {
        "*.scss": ["@parcel/transformer-sass", "@parcel/transformer-postcss"]
    }
};
